      ...
      <div className="container mx-auto px-4">
        ...
        >
          <h2 className="text-4xl md:text-5xl font-bold text-foreground mb-4 text-balance">
            {"What Our "}
            <span className="text-[oklch(0.65_0.18_155)]">{"Clients Say"}</span>
          </h2>
        ...
        >
          <div className="glass-strong rounded-2xl p-8 md:p-12 border border-[oklch(0.65_0.18_155/0.2)] relative">
            <Quote size={48} className="text-[oklch(0.65_0.18_155/0.3)] mb-6" />

            <div className="space-y-6">
              <div className="flex gap-1 mb-4">
                {Array.from({ length: testimonials[currentIndex].rating }).map((_, i) => (
                  <Star key={i} size={20} className="fill-[oklch(0.65_0.18_155)] text-[oklch(0.65_0.18_155)]" />
                ))}
              </div>
              ...
              <div className="pt-6 border-t border-border/30">
                ...
                <p className="text-sm text-[oklch(0.65_0.18_155)] mt-1">{testimonials[currentIndex].project}</p>
              </div>
            </div>
            ...
            <div className="flex items-center justify-between mt-8">
              <button
                ...
                className="p-3 glass rounded-full hover:bg-[oklch(0.65_0.18_155/0.2)] transition-colors"
